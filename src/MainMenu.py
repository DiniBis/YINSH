...
texte_titre = police_titre.render("Yinsh 2049", True, noir)
...
def Menu():
    ...
    nombre_joueurs = 1
    boutons_options = [
        {"label": f"Mode Blitz: {'oui' if mode_blitz else 'non'}",
         "rect": pygame.Rect(largeur_fenetre // 2 - 150, hauteur_fenetre // 2 - 30, 300, 50)},
